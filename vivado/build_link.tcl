...
#open_project -reset test_dnn_prj
#set_top test_dnn
#set outputDir ./build/
...
connect_bd_intf_net -intf_net control_interconnect_m02_axi [get_bd_intf_pins control_interconnect/M02_AXI] [get_bd_intf_pins ex_1layer/S_AXI_CONTROL_BUS]
connect_bd_intf_net -intf_net ex_1layer_output_stream [get_bd_intf_pins ex_1layer/out_stream] [get_bd_intf_pins DMA_controller/S_AXIS_S2MM]
...
create_bd_addr_seg -range 0x10000    -offset 0x43C00000 [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs ex_1layer/S_AXI_CONTROL_BUS/Reg] SEG_controller_Reg
validate_bd_design
#Finish it up
make_wrapper -files [get_files /local/pharris/Xilinx_DNN/MLinFPGAs/vivado/test_dnn/test_dnn.srcs/sources_1/bd/test_dnn/test_dnn.bd] -top
add_files -norecurse /local/pharris/Xilinx_DNN/MLinFPGAs/vivado/test_dnn/test_dnn.srcs/sources_1/bd/test_dnn/hdl/test_dnn_wrapper.vhd
